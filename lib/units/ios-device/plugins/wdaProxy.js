...
// Changes made by Wynand, new iproxy
// new- iproxy 16140 18140 -l -s 127.0.0.1 -u f793fc704a671534a8df987c2f1b4994232dd242
// old - iproxy 16140 18140 f793fc704a671534a8df987c2f1b4994232dd242

  plugin.startIproxy = function(localPort,remotePort){
    log.info("new start iproxy with params:%d %d %s",localPort,remotePort,wendy,options.serial)
    pro = new SubpPocess("iproxy",[localPort,remotePort,wendy,options.serial])
    pro.start();
    ...
    return new Promise((resolve,reject)=>{
      ...
      wdaPro.on("stream-line",line=>{
        ...
        if(line.indexOf("** TEST BUILD SUCCEEDED **")!=-1)
          log.info("xcodebuild by Wynand")
        else if (line.indexOf("ServerURLHere->")!=-1){
          log.info("WDA by Wynand - Started")
